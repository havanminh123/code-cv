...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['delete']))
  {
    ...
    if($id == $row_acc['id'])
      $error['accUsing'] = 'Account <b> is in use </b>! You cannot Delete the account.';
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Delete successful account.';
...
Account
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ds-tai-khoan.php?p=account&a=list-account">
        Account</a></li>
        <li class="active">
        List of accounts</li>
      </ol>
