        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">edit Reward</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input name Reward" name="tenKhenThuong" value="<?php echo $rowKT['ten_khen_thuong']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <?php 
                        if($rowKT['hinh_thuc'] == 1)
                        {
                          ...
                          echo "<option value='0'>Gửi money mặt</option>";
                        }
                        else
                        {
                          echo "<option value='1'>Chuyển khoản qua thẻ</option>";
                          echo "<option value='0' selected>Gửi money mặt</option>";
                        }
                      ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input  bonus" name="soTienThuong" value="<?php echo $rowKT['so_tien']; ?>">
                    </div>
                    <div class="form-group">
