...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_GET['id']))
  {
    ...
    { 
      ...
      if($resultXoaNhom)
      {
        $success['success'] = 'Delete Group Success';
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p><a href="chi-tiet-nhom.php?p=group&a=list-group&id=<?php echo $nh['ma_nhom']; ?>" class="small-box-footer" style='color: #fff;'>Detail Group <i class="fa fa-arrow-circle-right"></i></a></p>
              </div>
              <div class="icon">
                <i class="fa fa-users"></i>
              </div>
              <a onclick="return confirm('Do you really want to Delete Group This?')" href="danh-sach-nhom.php?id=<?php echo $nh['ma_nhom']; ?>" class="small-box-footer">Delete Group <i class="fa fa-trash"></i></a>
            </div>
          </div>
        <?php
          }
