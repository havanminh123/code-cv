...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($titlePosition))
      $error['titlePosition'] = 'Please enter <b> job title </b>';
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      Position name: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $row['ten_chuc_vu']; ?>" name="titlePosition">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Daily salary: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Daily salary" value="<?php echo $row['luong_ngay']; ?>" name="salary">
                    </div>
                    <div class="form-group">
