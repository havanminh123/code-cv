...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($titleLevel))
      $error['titleLevel'] = 'Please enter <b> level name </b>';
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Qualification code: </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="titleLevel" value="<?php echo $row['ten_trinh_do']; ?>">
                    </div>
                    <div class="form-group">
