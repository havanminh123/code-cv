...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Create expertise Success';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Delete expertise Success.';
    echo '<script>setTimeout("window.location=\'chuyen-mon.php?p=staff&a=specialize\'",1000);</script>';
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Do you really want to Delete expertise This?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Create expertise</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Create expertise</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input name expertise" name="titleSpecial">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Create expertise</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of expertise</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
