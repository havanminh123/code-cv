...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['delete']))
  {
    ...
    if($id == $row_acc['id'])
      $error['accUsing'] = 'Account <b> sử dụng </b>! Bạn không thể Delete Account.';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Do you really want to Delete Account This?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List of Account</li>
      </ol>
    </section>
                      ...
                      <tr>
                        ...
                        <th>
                          <?php 
                            ...
                            {
                               echo "<span class='label label-danger'>Shut down</span>";
                            }
                          ?>
                        </th>
                        <th>
