...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($titleLevel))
      $error['titleLevel'] = 'Please input <b> level name </b>';
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Create level Success';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Delete level Success.';
    echo '<script>setTimeout("window.location=\'trinh-do.php?p=staff&a=level\'",1000);</script>';
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Do you really want to Delete level This?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="trinh-do.php?p=staff&a=level">Level</a></li>
        ...
        <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Level code: </label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input level name" name="titleLevel">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Create level</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of level</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
