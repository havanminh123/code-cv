...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Saved successfully.';
...
Departments
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="phong-ban.php?p=staff&a=room">
        Departments</a></li>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $row['ten_phong_ban']; ?>" name="roomName">
                    </div>
                    <div class="form-group">
