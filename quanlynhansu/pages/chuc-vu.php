...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($titlePosition))
      $error['titlePosition'] = 'Please input <b> position name </b>';
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Add position Success';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Delete position Success.';
    echo '<script>setTimeout("window.location=\'chuc-vu.php?p=staff&a=position\'",1000);</script>';
  }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="chuc-vu.php?p=staff&a=position">Position</a></li>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input position name" name="titlePosition">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">
                      Daily salary: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="
Enter salary/day" name="salary">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Add position</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
