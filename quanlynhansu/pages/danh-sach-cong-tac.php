...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['delete']))
  {
    ...
    {
      $showMess = true;
      $success['success'] = 'Delete Collaborate Success.';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Do you really want to Delete Collaborate This?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="danh-sach-cong-tac.php?p=collaborate&a=list-collaborate">Collaborate</a></li>
        <li class="active">List of Collaborate</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Collaborate</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  ?>
                      <tr>
                        ...
                        <?php 
                          ...
                          {
                            echo '<td><span class="badge bg-blue"> Collaborate </span></td>';
                          }
                          else
                          {
                            echo '<td><span class="badge bg-red"> Expired </span></td>';
                          }
                        ?>
                        </td>
                        <td>
