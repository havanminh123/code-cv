<?php 
	...
	// PHPExcel
  	...
  	$sheet = $objExcel->getActiveSheet()->setTitle('Payroll');
  	...
  	$sheet->setCellValue('B' . $rowCount, 'Code Salary');
  	$sheet->setCellValue('C' . $rowCount, 'Username');
  	$sheet->setCellValue('D' . $rowCount, 'position');
  	$sheet->setCellValue('E' . $rowCount, 'Salary month');
  	$sheet->setCellValue('F' . $rowCount, 'Work day');
  	$sheet->setCellValue('G' . $rowCount, 'Truly cool');
  	$sheet->setCellValue('H' . $rowCount, 'Date  timekeeping');
