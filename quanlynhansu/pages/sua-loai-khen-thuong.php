        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">edit type  Reward</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input name type " value="<?php echo $row['ten_loai']; ?>" name="tenLoai">
                    </div>
                    <div class="form-group">
