...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if($row_acc['email'] == $_POST['email'])
      $error['checkUsing'] = 'Không thể edit <b> Account sử dụng</b>';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ds-tai-khoan.php?p=account&a=list-account">Account</a></li>
            ...
            <form role="form" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Input Surname" name="lastName" value="<?php echo $row['ho']; ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">name: <b style="color: red;">*</b></label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Input name" name="firstName" value="<?php echo $row['ten']; ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Email: <b style="color: red;">*</b></label>
                  <input type="email" class="form-control" id="exampleInputPassword1" placeholder="Input email" name="email" value="<?php echo $row['email']; ?>" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1"> phone:</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Input  phone" name="phone" value="<?php echo $row['so_dt']; ?>">
                </div>
                <div class="form-group">
                  ...
                  <?php 
                    if($row['quyen'] == 1)
                    {
                      ...
                      echo "<lable>";
                      echo "<input type='radio' name='level' class='minimal' value='0'> Staff";
                      echo "</lable>";
                    }
                    else
                    {
                      ...
                      echo "<lable>";
                      echo "<input type='radio' name='level' class='minimal' value='0' checked> Staff";
                      echo "</lable>";
                    }
                  ?>
                  </div>
