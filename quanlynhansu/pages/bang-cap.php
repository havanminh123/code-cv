...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($certificateName))
      $error['certificateName'] = 'Please input <b> name degree </b>';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        $success['success'] = 'Create degree Success';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Delete degree Success.';
    echo '<script>setTimeout("window.location=\'bang-cap.php?p=staff&a=certificate\'",1000);</script>';
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Do you really want to Delete degree This?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="bang-cap.php?p=staff&a=certificate">Degree</a></li>
        ...
        <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Code degree: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="speacialCode" value="<?php echo $certificateCode; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name degree: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input name degree" name="certificateName">
                    </div>
                    <div class="form-group">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Create degree</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of degree</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
